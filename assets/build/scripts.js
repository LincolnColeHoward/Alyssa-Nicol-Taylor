...
e(t),n.gallery.btn.onclick=function(){e("gallery"),galleryEmpty&&galleryEmpty()},n.bio.btn.onclick=function(){e("bio")},n.cv.btn.onclick=function(){e("cv"),cvConfig||runCvConfig(),cvConfig()}}function galleryConfig(){function e(){GET("/galleries/length",function(e){for(var r=0;e>r;r++)GET("/galleries/"+r,function(e){n(e),t(e)})})}function n(e){if(!d[e.year]){d[e.year]=[],f[e.year]=[]
...
n.onclick=a(t,e),f[e.year].push(n)}function r(){for(var e=document.querySelectorAll("div.thumbnail-item"),n=0;n<e.length;n++)e[n].className="hidden"}function o(e){var n=f[e],t=Math.floor(Math.random()*n.length)
c(n[t].children[0],d[e][t])
for(var r=0;r<n.length;r++)n[r].className="thumbnail-item"}function i(e){return function(){r(),o(e)}}function c(e,n){s.innerHTML=n.title||"",y.innerHTML=n.copyright||"",g.innerHTML=n.dimensions||"",h.innerHTML=n.media||""
var t=e.cloneNode()
m.innerHTML="",m.appendChild(t),galleryEmpty=!1}function a(e,n){return function(){c(e,n)}}var l=document.querySelector("#galleryList"),u=document.querySelector("#thumbnail"),d={},f={}
galleryEmpty=function(){var e=Object.keys(d),n=Math.floor(Math.random()*e.length)
n=e[n],o(n)}
var m=document.querySelector("#galleryMain"),s=document.querySelector("#image_title"),y=document.querySelector("#image_copyright"),g=document.querySelector("#image_dimensions"),h=document.querySelector("#image_media")
e()}function runCvConfig(){var e=document.querySelector("#cvContainer"),n="other/CV.pdf"
PDFJS.workerSrc="build/pdf.worker.js",PDFJS.getDocument(n).then(function(n){n.getPage(1).then(function(n){cvConfig=function(){var t=n.getViewport(1),r=e.clientWidth/t.width,t=n.getViewport(r),o=document.querySelector("#CV"),i=o.getContext("2d")
